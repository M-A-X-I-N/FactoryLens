...
- `FL-B100-validate-compile-metadata.ps1` — runs the real Windows FL-B100 compile-metadata/mutation-audit validation with JDK 25 selected for the Gradle process.
