...
| **FL-B120** | **NEXT** | Implement project/source boundary classification. | The analyzer can distinguish the target mod/project from Unreal Engine, SML, FactoryGame, dependency mods, generated code, and other external boundaries well enough for project-local traversal/filtering. |
