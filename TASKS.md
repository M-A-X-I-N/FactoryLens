...
| **FL-B150** | **NEXT** | Implement the root-provider interface and external-override provider. | The supported analyzer discovers external virtual/framework override candidates, records external base provenance, and can use foreground semantic verification when index-backed coverage is uncertain. |
